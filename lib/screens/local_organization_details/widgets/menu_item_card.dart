...
class MenuItemCard extends StatelessWidget {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: NetworkImage(menuItem.urlImage),
                        fit: BoxFit.cover
                      )
                  ),
                ),
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Align(
                      ...
                      child: Text(
                        "${menuItem.price.toStringAsFixed(2)} тг",
  ...
  void _showMenuItemDetails(BuildContext context, FoodMenuItem menuItem) {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 5),
                    Text("${menuItem.price.toStringAsFixed(2)} тг",
                    ...
                    child: BlocBuilder<MenuItemQuantityCubit, MenuItemQuantityState>(
                      builder: (context, state) {
                        return ElevatedButton(
                          ...
                          child: Text(
                            "Добавить в корзину ${(menuItem.price * state.quantity).toStringAsFixed(2)} тг",
