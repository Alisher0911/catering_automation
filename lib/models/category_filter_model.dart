...
class CategoryFilter extends Equatable {
  ...
  CategoryFilter({ required this.id, required this.category, required this.value});
  ...
  CategoryFilter copyWith ({
    ...
    return CategoryFilter(id: id ?? this.id, category: category ?? this.category, value: value ?? this.value);
  }
